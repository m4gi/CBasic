...
void menu()
{
	...
	{
		system("cls");
		printf("USE KEYS: UP, DOWN, LEFT, RIGHT \nTO CONTROL YOUR SNAKE\n\n");
		printf("WHEN YOU EAT FRIUT YOU GET 5 POINT\n\n");
		printf("WHEN YOU HIT YOURSELF YOU LOSE\n\n");
		printf("ENTER TO GO BACK TO MENU...");
		char enter;
		while (1)
		{
			enter = getch();
